...
from app.api.endpoints import (
    ...
    douyin_web,
    bilibili_web,
    hybrid_parsing, ios_shortcut, download, cookie_manager,
)
...
# Cookie Manager routers
router.include_router(cookie_manager.router, prefix="/cookie", tags=["Cookie-Manager"])
